    ...
    <div class="sidebar-collapse">
        ...
        <ul class="nav" id="side-menu">
            ...
            <li class="<?php if ($_GET['rik'] == "data-Instansi" or $_GET['rik'] == "tambah-Instansi" or $_GET['rik'] == "detail-Instansi" or $_GET['rik'] == "ubah-Instansi" or $_GET['rik'] == "data-pembimbing-lapangan" or $_GET['rik'] == "tambah-pembimbing-lapangan" or $_GET['rik'] == "detail-pembimbing" or $_GET['rik'] == "ubah-pembimbing" or $_GET['rik'] == "data-dosen-pembimbing" or $_GET['rik'] == "tambah-dosen-pembimbing" or $_GET['rik'] == "detail-dosen-pembimbing" or $_GET['rik'] == "ubah-dosen-pembimbing") {
                ...
                <ul class="nav nav-second-level">
                    ...
                    if ($_SESSION['hak_akses'] == "admin") { ?>
                        <li class="child-menu <?php if ($_GET['rik'] == "data-pembimbing-lapangan" or $_GET['rik'] == "tambah-pembimbing-lapangan" or $_GET['rik'] == "detail-pembimbing" or $_GET['rik'] == "ubah-pembimbing") {
                                                    echo 'selected';
                                                } ?>">
                            <a href="?rik=data-pembimbing-lapangan">Pembimbing Lapangan</a>
                        </li>
                        <li class="child-menu <?php if ($_GET['rik'] == "data-Instansi" or $_GET['rik'] == "tambah-Instansi" or $_GET['rik'] == "detail-Instansi" or $_GET['rik'] == "ubah-Instansi") {
                                                    echo 'selected';
                                                } ?>">
            ...
            if ($_SESSION['hak_akses'] == "admin") { ?>
                <li class="<?php if ($_GET['rik'] == "data-Kelompok" or $_GET['rik'] == "tambah-Kelompok" or $_GET['rik'] == "detail-Kelompok" or $_GET['rik'] == "ubah-Kelompok" or $_GET['rik'] == "data-DokumenKkp" or $_GET['rik'] == "detail-DokumenKkp" or $_GET['rik'] == "hapus-Kelompok" or $_GET['rik'] == "ubah-DokumenKkp" or $_GET['rik'] == "data-DokumenKkp" or $_GET['rik'] == "data-DownloadDokumenKKP") {
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="child-menu <?php if ($_GET['rik'] == "data-DokumenKkp" or $_GET['rik'] == "detail-DokumenKkp" or $_GET['rik'] == "hapus-Kelompok" or $_GET['rik'] == "ubah-DokumenKkp") {
                                                    echo 'selected';
                                                } ?>">
                ...
                <li class="<?php if ($_GET['rik'] == "data-Dokumenskripsi" or $_GET['rik'] == "tambah-DokumenSkripsi" or $_GET['rik'] == "detail-DokumenSkripsi" or $_GET['rik'] == "ubah-DokumenSkripsi" or $_GET['rik'] == "data-DownloadDokumenSkripsi") {
                                echo 'active';
                            } ?>">
                    <a href="#"><i class="fa fa-file fa-fw"></i> Skripsi<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li class="child-menu <?php if ($_GET['rik'] == "data-Dokumenskripsi" or $_GET['rik'] == "tambah-DokumenSkripsi" or $_GET['rik'] == "detail-DokumenSkripsi" or $_GET['rik'] == "ubah-DokumenSkripsi") {
                                                    echo 'selected';
                                                } ?>">
                ...
                <li class="<?php if ($_GET['rik'] == "data-admin" or $_GET['rik'] == "tambah-Admin" or $_GET['rik'] == "detail-admin" or $_GET['rik'] == "ubah-Admin" or $_GET['rik'] == "data-dosen" or $_GET['rik'] == "tambah-dosen" or $_GET['rik'] == "detail-dosen" or $_GET['rik'] == "ubah-dosen" or $_GET['rik'] == "data-mahasiswa" or $_GET['rik'] == "tambah-mahasiswa" or $_GET['rik'] == "detail-mahasiswa" or $_GET['rik'] == "ubah-mahasiswa") {
                                echo 'active';
                            } ?>">
                    <a href="#"><i class="fa fa-users fa-fw"></i> Pengguna<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li class="child-menu <?php if ($_GET['rik'] == "data-admin" or $_GET['rik'] == "tambah-Admin" or $_GET['rik'] == "detail-admin" or $_GET['rik'] == "ubah-Admin") {
                                                    echo 'selected';
                                                } ?>">
                            <a href="?rik=data-admin">Admin</a>
                        </li>
                        <li class="child-menu <?php if ($_GET['rik'] == "data-dosen" or $_GET['rik'] == "tambah-dosen" or $_GET['rik'] == "detail-dosen" or $_GET['rik'] == "ubah-dosen") {
                                                    echo 'selected';
                                                } ?>">
                            <a href="?rik=data-dosen">Dosen</a>
                        </li>
                        <li class="child-menu <?php if ($_GET['rik'] == "data-mahasiswa" or $_GET['rik'] == "tambah-mahasiswa" or $_GET['rik'] == "detail-mahasiswa" or $_GET['rik'] == "ubah-mahasiswa") {
                                                    echo 'selected';
                                                } ?>">
            ...
            if ($_SESSION['hak_akses'] == "mahasiswa") { ?>
                <li class="<?php if ($_GET['rik'] == "data-DokumenKkp" or $_GET['rik'] == "tambah-DokumenKkp" or $_GET['rik'] == "detail-DokumenKkp" or $_GET['rik'] == "ubah-DokumenKkp") {
                                echo 'active';
                            } ?>">
                    <a href="#"><i class="fa fa-users fa-fw"></i> KKP<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li class="child-menu <?php if ($_GET['rik'] == "data-DokumenKkp" or $_GET['rik'] == "tambah-DokumenKkp" or $_GET['rik'] == "detail-DokumenKkp" or $_GET['rik'] == "ubah-DokumenKkp") {
                                                    echo 'selected';
                                                } ?>">
                ...
                <li class="<?php if ($_GET['rik'] == "data-UploadSkripsi" or $_GET['rik'] == "tambah-UploadSkripsi" or $_GET['rik'] == "detail-DokumenSkripsi" or $_GET['rik'] == "ubah-UploadSkripsi") {
                                echo 'active';
                            } ?>">
                    <a href="#"><i class="fa fa-users fa-fw"></i> SKRIPSI<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li class="child-menu <?php if ($_GET['rik'] == "data-UploadSkripsi" or $_GET['rik'] == "tambah-UploadSkripsi" or $_GET['rik'] == "detail-DokumenSkripsi" or $_GET['rik'] == "ubah-UploadSkripsi") {
                                                    echo 'selected';
                                                } ?>">
