...
if (isset($_POST['cari'])) {
    ...
    $dok_kkp = new MengelolaDokumenKkp();
    $data_cari = $dok_kkp->MencariByTahun($tahun_cari);
    // print_r($data_cari);
    // die;
?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if ($_SESSION['hak_akses'] == "dosen") { ?>
                                            <a href="app/kkp/download-kkp.php?filename=<?= $data->file_lengkap_laporan_kkp ?>" target="_blank">FULL</a>
                                        <?php } else { ?>
                                            <a href="app/kkp/download-kkp.php?filename=<?= $data->file_bab_I ?>" target="_blank">BAB 1</a>
                                        <?php } ?>
                                    </td>
                                </tr>
