...
require_once "../../../sistem/application/KKP/DownloadDokumenKKP/MengelolaDownloadDokumenKKP.php";
    ...
    if ($_SESSION['hak_akses']=="dosen") {
        ...
        $download = new MengelolaDownloadDokumenKKP('',$id_dokumen,$id_dosen,$tanggal_download);
